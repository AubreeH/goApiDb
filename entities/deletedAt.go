...
type DeletedAt struct {
	DeletedAt dataTypes.NullTime `json:"deleted_at" sql_type:"DATETIME" sql_nullable:"true" sql_disallow_external_modification:"true" parse_struct:"false" soft_deletes:"true"`
}
